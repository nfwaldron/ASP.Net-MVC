...
namespace TwoFactory_and_EmailConfirmation
{
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            var Twilio = new TwilioRestClient("AC78a93a7e86063250cfa6937de4441446", "a9cd2ff4462c99077760af147279bf9c");
            Twilio.SendMessage("(857) 399-0830", message.Destination, message.Body);
